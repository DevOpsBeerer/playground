...
## Install operator
helm --kubeconfig $KUBECONFIG upgrade --install devopsbeerer-operator oci://rg.fr-par.scw.cloud/devopsbeerer/charts/devopsbeerer-operator \
    --namespace devopsbeerer-operator \
    --create-namespace
